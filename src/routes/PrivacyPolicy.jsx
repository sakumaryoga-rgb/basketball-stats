  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Section title="2. 取得・保存する情報">
        ...
        <ul className="list-disc pl-5 flex flex-col gap-1">
          <li>氏名または表示名</li>
          <li>背番号・ポジション・身長・体重</li>
          <li>写真</li>
          <li>その他、チーム管理者または利用者が任意に入力するプロフィール情報</li>
        </ul>
      ...
      <Section title="5. 情報の共有・第三者への提供">
        <ol className="list-decimal pl-5 flex flex-col gap-1">
          <li>チームに登録された選手情報、写真、試合記録、スタッツその他のチームデータは、招待コード等により同じチームへ参加しているメンバー間で共有されます。同一チームに参加した利用者は、原則としてチーム内のすべての登録データを閲覧・編集できます。</li>
      ...
      <Section title="6. データ・チームの削除">
        <ol className="list-decimal pl-5 flex flex-col gap-1">
          ...
          <li>
            現時点では、匿名アカウント自体をアプリ内から削除する機能は提供していません。匿名アカウントおよびそれに関連する情報の削除をご希望の場合は、第10項のお問い合わせ先までご連絡ください。
          </li>
      ...
      <Section title="7. localStorage、Cookieおよびトラッキング">
        <ol className="list-decimal pl-5 flex flex-col gap-1">
          <li>本サービスでは、ログイン状態、表示中のチームその他利用状態を維持するため、ブラウザのlocalStorageその他端末内の保存機能を利用しています。</li>
      ...
      <Section title="10. お問い合わせ">
        <p>
          本ポリシー、利用者情報またはデータの削除等に関するお問い合わせは、メニューの「お問い合わせ」または下記メールアドレスよりご連絡ください。
        </p>
        <p>
          このお問い合わせはご利用の端末のメールアプリを起動するリンクであり、本サービスのサーバーを経由してお問い合わせ内容を収集・保存するものではありません。
        </p>
        <p>
